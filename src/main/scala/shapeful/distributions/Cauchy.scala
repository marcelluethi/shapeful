...
/** Scalar Cauchy distribution (single random variable)
  *
  * Heavy-tailed distribution with no defined mean or variance. Also known as the Lorentz distribution.
  *
  * @param loc
...
/** Cauchy distribution
  *
  * Heavy-tailed distribution with independent elements. Has no defined mean or variance (infinite).
  *
  * @param loc
  *   Location parameter (median) for each element
  * @param scale
  *   Scale parameter for each element (must be positive)
  */
