...
/** Normal (Gaussian) distribution
  ...
  *
  * This is a factorized distribution: each element of the tensor is an independent normal random variable with its own
  * mean and std dev.
  *
  * @param mu
  *   Mean of the distribution
  ...
  */
class Normal[S <: Tuple](val mu: Tensor[S], val sigma: Tensor[S]) extends FactorizedDistribution[S]:
