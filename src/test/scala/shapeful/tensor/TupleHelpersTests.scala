...
class TupleHelpersTests extends FunSuite {
  ...
  test("ToIntTuple converts multiple element tuple") {
    ...
    val triple: ToIntTuple[String *: Boolean *: Double *: EmptyTuple] = (1, 2, 3)
  ...
  test("Remove removes element from tuple") {
    ...
    val removedString: Remove[String, String *: Int *: Boolean *: EmptyTuple] = (42, true)
    val removedInt: Remove[Int, String *: Int *: Boolean *: EmptyTuple] = ("hello", true)
    val removedBoolean: Remove[Boolean, String *: Int *: Boolean *: EmptyTuple] = ("hello", 42)
  ...
  test("Remove removes first occurrence only") {
    ...
    val withDuplicates: String *: Int *: String *: EmptyTuple = ("first", 42, "second")
    val removed: Remove[String, String *: Int *: String *: EmptyTuple] = (42, "second")
  ...
  test("RemoveAll removes first occurrence of each specified element") {
    ...
    val original: String *: Int *: Boolean *: String *: EmptyTuple = ("hello", 42, true, "world")
    val removed: RemoveAll[String *: Boolean *: EmptyTuple, String *: Int *: Boolean *: String *: EmptyTuple] = (42, "world")
  ...
  test("createTupleFromSeq creates correct tuples") {
    ...
    val triple = createTupleFromSeq[Int *: Int *: Int *: EmptyTuple](Seq(1, 2, 3))
    assertEquals(triple, (1, 2, 3))
    
    val quad = createTupleFromSeq[Int *: Int *: Int *: Int *: EmptyTuple](Seq(1, 2, 3, 4))
    assertEquals(quad, (1, 2, 3, 4))
    
    val five = createTupleFromSeq[Int *: Int *: Int *: Int *: Int *: EmptyTuple](Seq(1, 2, 3, 4, 5))
    assertEquals(five, (1, 2, 3, 4, 5))
    
    val six = createTupleFromSeq[Int *: Int *: Int *: Int *: Int *: Int *: EmptyTuple](Seq(1, 2, 3, 4, 5, 6))
  ...
  test("indicesOf finds indices of multiple elements") {
    ...
    val indices = indicesOf[String *: Boolean *: EmptyTuple, String *: Int *: Boolean *: EmptyTuple]
    assertEquals(indices, (0, 2))
    
    val singleIndex = indicesOf[Int *: EmptyTuple, String *: Int *: Boolean *: EmptyTuple]
    assertEquals(singleIndex, Tuple1(1))
    
    val emptyIndices = indicesOf[EmptyTuple, String *: Int *: Boolean *: EmptyTuple]
  ...
  test("createTupleFromSeq with too many elements should throw") {
    ...
    intercept[IllegalArgumentException] {
      createTupleFromSeq[Int *: EmptyTuple](Seq(1, 2, 3, 4, 5, 6, 7, 8)) // Too many elements
    }
  }
}
