...
object TensorOps:
  ...
  object Contraction:
    ...
    extension [T <: Tuple: Labels, V](tensor: Tensor[T, V])
      ...
      ](axes: (Axis[ContractAxis], Axis[OtherContractAxis]))(other: Tensor[OtherShape, V])(using
  ...
  object Functional:
    ...
    object ZipVmap:
      ...
      object ValueExtractor:
        type Aux[Inputs <: Tuple, V0] = ValueExtractor[Inputs] { type V = V0 }

        given nonEmpty[H, T <: Tuple, S <: Tuple, V0](using
            ev: H =:= Tensor[S, V0]
