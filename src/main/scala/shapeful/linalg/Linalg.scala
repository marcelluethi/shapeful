...
object Linalg:
  ...
  /** Computes the inverse of a square matrix.
    *
    * @param t
    *   A square Tensor2 matrix
    * @return
    *   The matrix inverse as a Tensor2 with transposed dimensions
    */
  ...
  /** Computes the Cholesky decomposition of a symmetric positive-definite matrix. The Cholesky decomposition is a
    * matrix L such that t = L * L.T
    *
    * @param t
    *   A symmetric positive-definite Tensor2 matrix
    * @return
    *   The lower-triangular Cholesky factor as a Tensor2
    */
