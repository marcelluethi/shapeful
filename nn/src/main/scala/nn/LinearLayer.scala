...
object LinearMap:
    ...
    case class Params[In](weight: Tensor1[In, DType.Float32.type], bias: Tensor0[DType.Float32.type])
    ...
    object Params:
        ...
        def apply[In : Label](paramKey: Key)(inputDim: Dim[In]): Params[In] = 
            ...
            Params(
                ...
                bias = Tensor0.of[DType.Float32.type].apply(0.0f),
            )

case class LinearMap[In : Label](params: LinearMap.Params[In]) extends Function[Tensor1[In, DType.Float32.type], Tensor0[DType.Float32.type]]:
    override def apply(x: Tensor1[In, DType.Float32.type]): Tensor0[DType.Float32.type] = 
        import params.{weight, bias}
        x.contract(Axis[In])(weight) + bias
